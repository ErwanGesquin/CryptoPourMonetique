...
public class TpCrypto {
	...
	public static void main(String[] args) {
		...
		/*
		 * // On créé l'objet Diffie-Helmann DiffieHelmann d = new
		 * DiffieHelmann(71, 0, 0);
		 * 
		 ...
		 * 
		 * // On créé ensuite les clés a transmettre de Alice a Bob et
		 * inversement. // Alice : d.setKeyA(d.generate_private_key(d.getA(),
		 * d.getG(), d.getP())); System.out.println("Alice: key= " +
		 * d.getKeyA()); // Bob : d.setKeyB(d.generate_private_key(d.getB(),
		 * d.getG(), d.getP())); System.out.println("Bob: key= " + d.getKeyB());
		 * 
